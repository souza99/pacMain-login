...
class Game:
    ...
    def carregar_arquivos(self):
        ...
        self.pacman_start_logo = os.path.join(diretorio_imagens, constantes.PACMAIN_START_LOGO)
    ...
    def mostrar_tela_start(self):
        ...
        pygame.display.flip()
        self.esperar_primeira_interacao()
    
    def esperar_primeira_interacao(self):
        esperando = True
        while esperando:
            self.relogio.tick(constantes.FPS)
            for event in pygame.event.get():
